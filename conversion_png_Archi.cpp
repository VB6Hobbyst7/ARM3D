...
int main()
{
    ...
    pointeur_sphere_violette = stbi_load("./sphereviolette.png", &width, &height, &nchan, STBI_rgb);
    ...
    FILE* pFile2;
    pFile2 = fopen("C:/Users/Eric/Pictures/sphereviolette4bits.data", "wb");
    ...
    FILE* pFile;
    pFile = fopen("C:/Users/Eric/Pictures/sphereviolette2.data", "wb");
    ...
    FILE* pFile3;
    pFile3 = fopen("C:/Users/Eric/Pictures/sphereviolettepourArchi.bin", "wb");
    ...
    FILE* pFile4;
    pFile4 = fopen("C:/Users/Eric/Pictures/spherevioletterecree.data", "wb");

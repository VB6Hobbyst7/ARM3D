...
; echange les 2 points
	eorgt		r1,r1,r3		; swap r1,r3 ( x1,x2)
	eorgt		r3,r1,r3
	eorgt		r1,r1,r3
	eorgt		r2,r2,r4		; swap r2,r4 ( y1,y2)
	eorgt		r4,r2,r4
	eorgt		r2,r2,r4
...
; breakpoint
	...
	mov		R3,R7,asr #16		; R3 = partie entiere

	mov		R8,#0xFFFF
	and		R4,R7,R8			; on garde la virgule uniquement
	mov		R4,R4,asl #15		; virgule tout en haut
...
;	rsb 	r7,r7,#0
	...
	mov		R2,#32768			; 0.5
	mov		R2,R2,asl #15
	;mov		R2,#1073741824		; R2 = X partie virgule = 0.5 * 65536 << 15: pour l'arrondi
								; R1 = X partie entiere


boucle_increment_pente_negatif:
	str		R1,[R12],#4			; on stocke X
	adds	R2,R2,R4			; virgule X = virgule X + virgule de increment
	subvs	R1,R1,#1
	subs	R1,R1,R3			; entier X = entier X - entier de increment
	
	subs	R13,R13,#1			; Delta Y - 1
	bge		boucle_increment_pente_negatif		


Delta_X_positif:	


boucle_increment_pente_positif:

...
; automodifer mon code pour arreter le timer IRQ la premiere fois : STRB      R14,[R14,#0x28+2]
; mais pas les fois suivantes
;
; R12 = pointeur source des valeurs pour 0x36000000
; //R14 = 0x36000000;//
; ldr	R8,[R12],#4
; str	R8,[R8]
;
; dans vsync, remettre R12 au début suivant adresse vidéo courante
; 


; valeurs fixes RMA
.equ	ylines,			56
.equ	vsyncreturn,	7142+(128*200)						; 7142 vsyncreturn=7168+16-1-48   +   vsyncreturn+=7
...
; R12_FIQ=
; R13_FIQ=line count
; R14_FIQ=temp reg 2/set to IOC addr on exit = 0x3200000

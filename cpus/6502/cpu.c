...
char *cpu_copyright="vasm 6502 cpu backend 0.9a (c) 2002,2006,2008-2012,2014-2021 Frank Wille";
char *cpuname = "6502";
int bitsperbyte = 8;
int bytespertaddr = 2;
...
static void rangecheck(instruction *ip,taddr val,operand *op)
{
  switch (op->type) {
    case ZPAGE:
    case ZPAGEX:

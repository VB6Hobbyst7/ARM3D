...
procedure TFrmPLIEdit.Button1Click(Sender: TObject);
begin
with FrmPLst do
...
procedure TFrmPLIEdit.Button2Click(Sender: TObject);
begin
with FrmPLst do
...
GetFileTypes(ComboBox2.Items);
end;

procedure TFrmPLIEdit.ComboBox1Select(Sender: TObject);
begin
RadioButton13.Checked := True;
end;

procedure TFrmPLIEdit.Edit11Change(Sender: TObject);
begin
RadioButton7.Checked := True;
end;

procedure TFrmPLIEdit.Edit13Change(Sender: TObject);
begin
RadioButton9.Checked := True;
end;

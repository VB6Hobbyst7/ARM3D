...
procedure LZHDepacker(Handle:integer;PBuffer:pointer;Size:Int64;Reader:PReadBlock);
...
BEGIN
  ...
  move(PByte(from)^[Position_in_External_Buf],p^,n);
...
BEGIN
  Hash:=p+smallint(c SHL (DICBIT-9))+2*DICSIZ;
END;

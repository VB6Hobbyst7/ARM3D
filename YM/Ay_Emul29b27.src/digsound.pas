...
type
  digsound_retcodes = (
   ...
   digsound_rc_already_opened = digsound_rc_first_nodriver,
  ...
  function digsound_getposition(var Position:int64):integer;
...
if BufferDoneEvent then
 ...
 i := CALLBACK_NULL;
if not WOChecked(waveOutOpen(@hwo,device-1,@pwfx,DWORD_PTR(digsound_event),0,i)) then

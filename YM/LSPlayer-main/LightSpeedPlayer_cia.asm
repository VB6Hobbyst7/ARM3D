...
.LSP_IrqInstall:
			...
			lea		.ciaClock(pc),a5
			move.l	d1,(a5)
			divu.w	d0,d1						; d1=D1/d0 : 1773447 / bpm   .709379 Mhz PAL 709379 Hz : pour 125 : 14 187,576 : 50 HZ
			move.b	d1,$400(a0)					; CIAB timer A low byte
			lsr.w 	#8,d1
			move.b	d1,$500(a0)					; CIAB timer A high byte
			move.b	#$83,$d00(a0)
			move.b	#$11,$e00(a0)

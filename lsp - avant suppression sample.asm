...
; - virer le sample 
; - initialiser les canaux avec le silence, rechecker tout.
; - mettre en place la gestion de dmacon : avant le mixage, si bit du canal =0 => initialiser vers du silence : offset du silence + increment=0 + volume=0

...
:
FNlong_adr("",0,regtable)			; adr R0,regtable
LDMIA     R0,{R0-R3}
CMP       R0,#0
CMPGT     R1,#0
CMPGT     R2,#0
...
.FIQ_startofcode
TEQP      PC,#%11<<26 OR %01  ; 1 18 keep IRQs and FIQs off, change to FIQ mode : irq et fiq OFF (status register dans le PC) + FIQ mode activé

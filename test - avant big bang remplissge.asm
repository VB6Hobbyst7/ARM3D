...
; R5 = masque #0xFFF0
	...
	ldr		r2,[r11,r2]				; r2=y min * 320
	add		r13,r2,r13			; pointeur ecran + y*320
		
	mov		r1,#45				; couleur dans 4 registres
	mov		r2,r1
	mov		r3,r1
	mov		r4,r1
...
boucle_remplissage_avec_sauts:
	...
	sub		R6,R12,R11			; Delta X : XD - XG
	and		R6,R6,R5			; on élimine les bits 0x0F des valeurs 0-15
	mov		R14,#fin_milieu		; pointeur sur les routines de milieu
	sub		R6,R14,R6,lsr #2		; /4 
	
	add		R14,R11,R13			; pointeur ecran + X gauche
	and		R11,R11,R0			; x gauche and 0x000F

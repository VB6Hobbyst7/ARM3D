...
; - remplissage normal
; - remplissage optimisé avec stm sur les multiples de 4
; - revoir le cls, pour multiple de 4 doubles mots
; cercles
; ellipses
...
; R11 : source numéros des points / structure
; R10 : coordonnees_projetees
; R5 : Y min
; R6 : Y max
; R7-R9 : pour les calculs
; R13-R14 dispos
